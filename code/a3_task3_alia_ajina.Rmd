...
```
Paragraph here about overall takeaways about how the size compare between the two species...
...
A finalized graph of counts of purple urchins recorded at each site over time for the years included in the study.
...
ggplot(data = total_purple_urchins, 
  ...
  labs( x = "Year",
        y = "Number of Urchins",
        title = " Distribution of Purple Urchins from 2008 - (AJINA)",
        subtitle = "", 
        key = "Site",
        fill = "Site",
        caption = "") +
