...
ggplot(data = total_purple_urchins, 
  ...
  scale_fill_manual(values = c("#B7E9F7", "#90EE90", "#F4F186", "#FED8B1", "#FFB6C1")) +
  theme_gray() + 
  scale_x_continuous(limits=c(2007,2020), breaks = c(2008, 2010, 2012, 2014, 2016, 2018, 2020)) + 
  ...
  labs( x = "Year",
        ...
        caption = "Figure 1.1: Distribution of purple sea urchins in each site from the years 2008 to 2020 from SBC LTER data") +
...
ggplot(data = total_purple_urchins, 
       aes(x = year, y = count)) + 
  geom_line(aes(color = site_full, scale = 'free')) +
  scale_color_manual(values = c("#B7E9F7", "#90EE90", "#F4F186", "#FED8B1", "#FFB6C1")) +
  theme_minimal() +  
  scale_x_continuous(limits=c(2007,2020), breaks = c(2008, 2010, 2012, 2014, 2016, 2018, 2020)) + 
